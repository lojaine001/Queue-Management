...
`requirements.txt` already includes the OpenVINO-enabled ONNX Runtime stack used by this app:
...
You should see `OpenVINOExecutionProvider` in the output when the environment is installed correctly.
