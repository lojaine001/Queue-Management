...
class YOLOv9:
    ...
    def postprocess(self, outputs, image_height=None, image_width=None):
    ...
    def detect(self, img: np.ndarray, image_height: int = None, image_width: int = None) -> List:
        input_tensor = self.preprocess(img)
        outputs = self.session.run(self.output_names, {self.input_names[0]: input_tensor})[0]
        return self.postprocess(outputs, image_height, image_width)
