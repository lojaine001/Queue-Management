...
const T = {
  fr: {
    ...
    laneScenarios: 'SCÉNARIOS FILES',
    simulateScenarios: "Simuler l'ouverture de files supplémentaires",
    ...
    maxWaitTime: "Temps d'attente max",
    avgOpenLanes: 'Files ouvertes (moyenne)',
  ...
  en: {
    ...
    laneScenarios: 'LANE SCENARIOS',
    simulateScenarios: 'Simulate opening additional lanes',
    ...
    avgOpenLanes: 'Open lanes (average)',
